...
- [dataone](https://cloud.r-project.org/web/packages/dataone/): DataOne ([Data Observation Network for Earth](https://www.dataone.org/)) is a very general data repository. This package does support uploading datasets to the [DataOne cloud](https://cran.r-project.org/web/packages/dataone/vignettes/v05-upload-data.html) 
...
The above tools are built to interact with single data repositories. I know of no tools that work across data repositories.
